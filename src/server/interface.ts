...
export interface AnalyzerPluginOptionsWithGzip extends BasicAnalyzerPluginOptions {
    defaultSizes: 'gzip'
    gzipOptions?: ZlibOptions
}

export type AnalyzerPluginOptions = BasicAnalyzerPluginOptions | AnalyzerPluginOptionsWithGzip
